...
function onOpen() {
  ...
  .addItem('Clear Order Details','clearOrderDetails')
...
function updateUserFilteredProductList() {
  ...
  shSalesOrder.autoResizeColumns(10,7); // J = Column 10
...
function clearOrderDetails() {
  ...
  if (result == ui.Button.YES) {
    ...
    ui.alert('The previous Order Details were successfully cleared.');
  } else {
    // User clicked "No" or X in the title bar.
    ui.alert('The existing Order Details were not changed.');
  }
}
